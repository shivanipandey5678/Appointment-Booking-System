...
const Header = () => {
  return (
    <div className='flex flex-col md:flex-row  bg-primary rounded-lg px-6 md:px-10 lg:px-20 gap-20'>
        {/* ----------left side---------- */}
        <div className='md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto'>
            ...
            <a href="#speciality" className='bg-white rounded-full flex items-center gap-2 px-8 py-3 text-grey-600 text-sm m-auto md:m-0 hover:scale-105 transition-all duration-300'>
              Book appointment
              <img src={assets.arrow_icon} alt=""  className='w-2'/>
            </a>
        ...
        <div className='md:w-1/2 relative  hidden md:block '>
            <img src={assets.header_img} alt="header_img" className='absolute  bottom-0  md:h-auto rounded-lg '/>
        </div>
